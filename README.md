...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fair-esm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15451&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fair-esm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fair-esm` can be installed with:

```
conda install fair-esm
```

It is possible to list all of the versions of `fair-esm` available on your platform with:
